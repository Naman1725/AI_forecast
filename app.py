...
def forecast():
    try:
        # Get parameters from form-data (CHANGED TO request.form)
        country = request.form.get("country")
        technology = request.form.get("technology")
        zone = request.form.get("zone")
        kpi = request.form.get("kpi")
        forecast_months = int(request.form.get("forecast_time", 3))  # Default to 3 months
